...
export default function HeroSearch() {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto bg-black/40 backdrop-blur-[40px] border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.6)] rounded-[32px] relative z-20">
      ...
      {/* Form (Responsive 4-Column Grid) */}
      <form onSubmit={handleSearch} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_56px] p-8 gap-5 items-center bg-black/20 rounded-b-[32px]">
        {/* Makes */}
        <CustomSelect 
          value={make} 
          onChange={(val) => {
